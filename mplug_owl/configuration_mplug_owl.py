...
""" MplugOwl mPLUG-Owl2 configuration"""
import copy
import os
...
class MplugOwlVisionConfig(PretrainedConfig):
    ...
    a
     mPLUG-Owl vision encoder according to the specified arguments, defining the mPLUG-Owl2 architecture. Instantiating a
     ...
     Configuration objects inherit from [`PretrainedConfig`] and can be used to control the mPLUG-Owl2 outputs. Read the
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs) -> "PretrainedConfig":
        ...
        if "model_type" in config_dict and hasattr(cls, "model_type") and config_dict["model_type"] != cls.model_type:
            logger.warning(
                f"You are using a mPLUG-Owl2 of type {config_dict['model_type']} to instantiate a mPLUG-Owl2 of type "
...
class MplugOwlConfig(PretrainedConfig):
    ...
    It is used to instantiate a mPLUG-Owl mPLUG-Owl2 according to the specified arguments, defining the vision mPLUG-Owl2,
    Q-Former mPLUG-Owl2 and language mPLUG-Owl2 configs. Instantiating a configuration with the defaults will yield a similar
    ...
    >>> mPLUG-Owl2 = MplugOwlForConditionalGeneration(configuration)

    >>> # Accessing the mPLUG-Owl2 configuration
    >>> configuration = mPLUG-Owl2.config
    ...
    >>> # Initializing mPLUG-Owl vision, mPLUG-Owl Q-Former and language mPLUG-Owl2 configurations
    ...
    def from_vision_visual_abstractor_text_configs(
        ...
        **kwargs,
        ...
        r"""
        Instantiate a [`MplugOwlConfig`] (or a derived class) from a mPLUG-Owl vision mPLUG-Owl2, Q-Former and language
        mPLUG-Owl2 configurations.
